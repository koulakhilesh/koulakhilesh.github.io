...
<p class="lab-lede">Half notebook, half playground: small things I build to understand ideas by making them move — algorithms you can watch think, logic puzzles, and a couple of games worth five idle minutes. More to come. <em>Psst:</em> type <code>life</code> or <code>ant</code> anywhere on the site, or try the Konami code.</p>
