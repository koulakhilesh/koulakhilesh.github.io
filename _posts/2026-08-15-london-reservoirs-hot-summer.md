...
The **Lower Thames** (bottom panel) starts the year mid-band, tracks the typical line into spring, then peels away and rides the **bottom edge of the grey band** all summer. Its 72% on 31 July isn't just low: it *matches the lowest level ever recorded for that date* in the 37-year record. For late July, the Thames group has never been emptier. It's on the floor of its own range.

The **Lower Lee** (top panel) tells a softer version. It fell too, but it's sitting comfortably *inside* the band, around the 24th percentile for the date: low-ish, nowhere near a record. Same city, same summer, two different responses. The structural gap between these systems, which the first post flagged, is doing real work here.

So the headline the slogan wanted, "record heat empties the reservoirs," is half right and half wrong, and the interesting half is the wrong one. One group is at a record low for the date; the other is just a bit dry. Which raises the obvious question: *did the Thames get there because this summer drained it unusually fast?*
...
So how is the Thames at a record low for the date if the fall wasn't record-breaking? Because of where it *started*. The Lee refilled to a brimming 100% over winter; the Thames only reached about 93%. A slightly lower starting line, plus a steep but not unprecedented fall, was enough to land it on the floor. The record isn't about how hard this summer pulled. It's about the summer landing on a spring that never quite topped the Thames up.

## What the data says

Reading the data rather than the headline:
...
- **But the drawdown wasn't the fastest.** 2022 and 2018 both drained faster. Record heat did not mean record-speed emptying.
...
- **The real test is still ahead.** July isn't the seasonal trough; that comes in September or October. If the Thames keeps hugging the bottom edge, *that* autumn minimum is the number to watch, against the deep droughts of 1996-97 the first post dug up.

None of this downplays the summer. A record-low-for-the-date reservoir is worth watching. But the outcome I'd have *guessed* ("hottest summer, fastest drain") isn't the one the data supports. The reservoirs are spending a full winter's savings fast, not running on empty, and the number that will really matter hasn't happened yet. I'll come back in October. The [notebook is here](https://github.com/koulakhilesh/CodePlayground/blob/main/london-reservoir-levels/reservoir_analysis_2026-07.ipynb) if you want to watch the floor with me.
